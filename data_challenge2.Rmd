...
sort(centroid.i - m.centroid.noti, decreasing = T)[1:10]
```
> Normalized data is not very useful when applying k-means clustering to this dataset because of the overly generalized words cancelling out other keywords that we might be interested in. 
